...
export default function AdminTestsPage() {
    return (
        <DashboardLayoutProvider
            ...
            description="Manage all online and offline assessments across the academy"
            icon={<GraduationCap />}
            bodyToolbar={
                <CreateTestModal />
            }
...
function AdminTests() {
    ...
    }, [allTests, search, filterSubjectId, filterCourseId, filterType, subjects])
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 py-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Field orientation="horizontal" className="w-fit">
                        <FieldLabel htmlFor="admin-tests-page-size">Rows</FieldLabel>
                        <Select value={pageSize.toString()} onValueChange={v => { setPageSize(Number(v)); setPage(1) }}>
                            <SelectTrigger className="w-16" id="admin-tests-page-size"><SelectValue /></SelectTrigger>
                ...
                <>
                    ...
                    <div className="overflow-hidden rounded-md border dark:border-slate-800">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 first:pl-4 text-muted-foreground">Test / Exam</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Subject</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Scheduled</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Duration</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Marks</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Mode</TableHead>
                                    <TableHead className="bg-secondary/50 dark:bg-slate-900 h-14 text-muted-foreground">Status</TableHead>
